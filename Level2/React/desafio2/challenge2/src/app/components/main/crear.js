...
export default function CrearComponent(){
    ...
    return(
        <>
            ...
            <div style={{width: '35rem'}} suppressHydrationWarning>
            <figure className='modal-user' dangerouslySetInnerHTML={{__html: feather.icons.user.toSvg()}}></figure>
                ...
                <div className="modal-dialog border-0">
                    <div className="modal-content border-0">
                        ...
                        <div className="modal-footer px-4 py-1 border-0">
                            ...
                            { inContent > 0 ?
                            <button type="button" className="btn btn-primary" style={{fontSize: '1rem', fontWeight: '700', color: 'grey'}}>Publicar</button> :
                            <button type="button" className="btn btn-primary" style={{fontSize: '1rem', fontWeight: '500', color: 'lightgrey'}}>Publicar</button>}
