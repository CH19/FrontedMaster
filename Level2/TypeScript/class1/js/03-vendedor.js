...
function bonoTerceraEdad(edad, genero) {
    if ((edad > 55 && genero === 'F') || (edad > 60 && genero === 'M'))
        return 40000;
    else
        return 0;
}
function sueldoFinal(sueldobass, bonoTerceraEdad, comision) {
